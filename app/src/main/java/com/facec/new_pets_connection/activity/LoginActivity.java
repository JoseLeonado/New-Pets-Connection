...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        campoEmail = findViewById(R.id.loginEditEmail);
        campoSenha = findViewById(R.id.loginEditSenha);
        botaoEntrar = findViewById(R.id.loginBtnEntrar);
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                ...
                if (task.isSuccessful()) {
                    ...
                    try {
                        ...
                        excecao = "Esse usuário não está cadastrado!";
